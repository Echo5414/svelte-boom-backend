...
export interface ApiGrenadeGrenade extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    lineup: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    precision: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiPrecisionPrecision extends Struct.CollectionTypeSchema {
  collectionName: 'precisions';
  info: {
    description: '';
    displayName: 'Precision';
    pluralName: 'precisions';
...
export interface ApiTechniqueTechnique extends Struct.CollectionTypeSchema {
